...
?>
	...
	<table>
		<thead>
			<tr>
                <th colspan="4">Résultats de la recherche</th>
			</tr>
		</thead>
		...
		<tbody>
			...
			<?php foreach($donnees as $donnee): ?>
			    <tr>
			        <td colspan="4"><strong><?= preg_replace('`'.$chainesearch.'`isU','<span style="font-weight: bold; color: orange; font-size:25px">$0</span>', $donnee['title']); ?></strong></td>
			    </tr>
				<tr>
