<?php
	...
	//Gérer les coordonnées du restaurant - Modifier la photo de couverture - Gérer les recettes (titre + contenu + photo + date & heure + id auteur) 
...
session_start();
//require_once 'inc/connect.php'; PAS DE CONNEXION A LA BASE DE DONNEE
NECESSAIRE
/*
...
$_SESSION['me']['firstname'] = $firstname;
$_SESSION['me']['lastname'] = $lastname;
